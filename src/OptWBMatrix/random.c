...
// pseudo-random number generator (PRNG) based on quadratic residues,
// called Quadratic Permuted Congruential Generator (QPRG)
unsigned int permuteQPR(unsigned int x) {
  // is this fixed prime modulus large enough??? Only 32-bit
